...
namespace elFinder.AspNet.Drawing
{
    ...
    public class DefaultPictureEditor : IPictureEditor
    {
        ...
        /// <returns>A new <see cref="Bitmap"/> that is just large enough to contain the rotated image without cutting any corners off.</returns>
        /// <remarks>Original code can be found at http://www.codeproject.com/Articles/58815/C-Image-PictureBox-Rotations </remarks>
        /// <exception cref="ArgumentNullException">Thrown if <see cref="image"/> is null.</exception>
